...
export default function Kunder() {
  ...
  return (
    <Page title="Kunder">
      Vi vill upprätthålla en god kommunikation till våra kunder. Därför finns det <Link to="/kontakt">kontaktmöjligheter</Link> så som e-post och telefon. Du som kund kan när som helst få uppdateringar om hur utvecklingen av produkten går och vid varje milstolpe informerar vi dig om alternativa lösningar om nuvarande läge.
      <CardList>
